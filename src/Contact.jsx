export default function Contact(){
    return(
        <section className="contact-section">
            ...
            <p>You officially got ducked by the society of ducks sympathizers</p>
        </section>
    );
}